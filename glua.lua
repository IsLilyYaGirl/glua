...
glua.cObjects = {}
--glua.physicsObjects = {}
setmetatable(glua._mt, {__mode = "v"})
...
glua.Component = {
	extends = glua.Instance,
	type = "Component",
	init = function(comp, params)
		comp.__itable = {}
		comp.Children = {}
		comp.Name = "Component"
		comp.__params = copy(params)
	end,
	__index = function(t, k)
		if t.__params[k] then
			return t.__params[k]
	...
	__newindex = function(t, k, v)
		if k == "Parent" then
			...
			if t.__params[k] then
				t.__params[k] = v
			elseif v:IsA("Component") then
				t.Children[v] = v
			else
				error("nonexistent parameter " .. k)
			end
		end
	end
}
